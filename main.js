(function(){
    ...
    function runner(){
        ...
        iframe.src = location.href.replace(/\/([^\/]+)?$/, "") + "/test/" + lib[index].toLowerCase() + "/" + (keyed ? "keyed.html" : strict ? "strict.html" : internal ? "internal.html" : "") + ("?duration=" + duration) + (reflow ? "&hidden=false" : "");
    }
