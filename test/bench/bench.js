...
function perform(){
    ...
    if(window === window.top){
        ...
        window.top.postMessage(test.name + "," + (status ? Math.floor(1000 / elapsed * loops) : 0) + "," + (status ? Math.ceil(memory / loops) : 0), location.protocol + "//" + location.hostname + (location.port ? ":" + location.port : "")) //"https://nextapps-de.github.io" "https://raw.githack.com"
    }
