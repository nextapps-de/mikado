 ...
 */
(function(){'use strict';var k;function m(a,b,c,d){if("tap"===b){if(w||C){aa(a);return}ba=!0;b="click"}window[(a?"add":"remove")+"EventListener"](b,c,d||!1)}
...
var F={},E={},da={},ca=document.documentElement||document.body.parentNode,w="ontouchstart"in window,C=!w&&window.PointerEvent&&navigator.maxTouchPoints,ba;G.route=G.prototype.route=function(a,b,c){E[a]=b;da[a]=c||{};return this};G.dispatch=G.prototype.dispatch=function(a,b,c,d){E[a].call(this,b,c,d);return this};var H,I,aa;
if(w||C){var ea=function(a,b){b&&(a=b[0]);H=a.clientX;I=a.clientY},fa=function(a){var b=H,c=I;ea(a,a.changedTouches);50>Math.abs(H-b)&&50>Math.abs(I-c)&&D.call(this,a,"tap")},ha=function(a){ea(a,a.touches)},ia={passive:!1,capture:!0};aa=function(a){m(a,C?"pointerdown":"touchstart",ha,ia);m(a,C?"pointerup":"touchend",fa,ia)}}G.listen=G.prototype.listen=function(a,b){F[a]||(m(1,a,D,b),F[a]=1);return this};G.unlisten=G.prototype.unlisten=function(a,b){F[a]&&(m(0,a,D,b),F[a]=0);return this};k=G.prototype;k.move=function(a,b){if("number"===typeof a){var c=a;a=this.b[c]}else c=this.index(a);0>b&&(b=this.length+b-1);c!==b&&this.shift(a,b-c);return this};
...
k.swap=function(a,b,c){if(a!==b){if("number"===typeof a){var d=a;a=this.b[a]}else d=this.index(a);if("number"===typeof b){var e=b;b=this.b[b]}else e=this.index(b);if(this.H&&(this.store||this.B)){var f=this.store?this.store[d]:a._m;this.update(a,this.store?this.store[e]:b._m,c,d);this.update(b,f,c,e)}else c=d+1!==e,this.root.insertBefore(c?a:b,c?b:a),c&&e+1!==d&&this.root.insertBefore(b,this.b[d+1]||null),this.b[d]=b,this.b[e]=a,this.store&&!this.J&&(a=this.store[e],this.store[e]=this.store[d],this.store[d]=
a)}return this};var J={};function ja(a){return J[a]=new RegExp("(?:^|\\s)"+a+"(?!\\S)","g")}function ka(a,b){K(a,b)||(a.className+=" "+b,a._c+=" "+b);return this}function la(a,b){b=(a._c||(a._c=a.className)).replace(J[b]||ja(b),"");a._c!==b&&(a.className=b,a._c=b);return this}function K(a,b){return!!(a._c||(a._c=a.className)).match(J[b]||ja(b))}function ma(a,b){var c=a._a||(a._a={}),d=c[b];return d||""===d?d:c[b]=a.getAttribute(b)};var na=window.localStorage;G.prototype.export=function(){if(this.store)var a=this.store;else if(this.B){a=Array(this.length);for(var b=0;b<this.length;b++)a[b]=this.b[b]._m}a&&na.setItem(this.l,JSON.stringify(a));return this};G.prototype.import=function(){var a=na.getItem(this.l);a&&(this.store=a=JSON.parse(a));return this};var L=Array.prototype,M=window.Proxy,N=0;function O(a){if(!(this instanceof O))return new O(a);if(a instanceof O)return a;this.view=this.w=null;var b=a?a.length:0;if(M){if(b)for(var c=0;c<b;c++)this[c]=a[c];this.length=b;this.D={splice:L.splice.bind(this),pop:L.pop.bind(this),shift:L.shift.bind(this),unshift:L.unshift.bind(this),push:L.push.bind(this)};return new Proxy(this,oa)}this.D=a||[];for(a=0;a<=b;a++)pa(this,a);N=b;pa(this,"length")}
function pa(a,b){Object.defineProperty(a,b,{get:function(){return this.D[b]},set:function(c){"number"===typeof b&&(b===N&&pa(this,++N),oa.set(this,b,c))}})}
var P=!1,oa={set:function(a,b,c){if("number"===typeof b)var d=!0;else{var e=parseInt(b,10);b===""+e&&(b=e,d=!0)}if(!P){P=!0;if((e=a.w)&&!e.K){var f=a.length;if(d){var g=e.length;f!==g&&(a.length=g);if(e.A&&a[b]===c)return P=!1,!0;d=a.view;b>=g?(e.add(c,d),a.length++):b<g&&(f=e.key,g=e.b[b],e.H||f&&g._k===c[f]?e.update(g,c,d,b):e.replace(g,c,d,b));if(e.proxy)return P=!1,!0}else"length"===b&&c<f&&e.remove(c,f-c)}P=!1}(M?a:a.D)[b]=c;return!0}};k=O.prototype;
k.swap=function(a,b){P=!0;this.w.swap(a,b,this.view);P=!1;return this};k.set=function(a){this.splice();return this.concat(a)};k.splice=function(a,b,c){P=!0;a||(a=0);"undefined"===typeof b&&(b=this.length-a,0>b&&(b=0));b&&this.w.remove(a,b);b=c?this.D.splice(a,b,c):this.D.splice(a,b);c&&this.w.add(c,a,this.view);P=!1;return b};k.push=function(a){P=!0;this.w.add(a,this.view);this.w.proxy||(this[this.length]=a);M&&this.length++;P=!1};
k.unshift=function(a){P=!0;this.w.add(a,0,this.view);this.D.unshift(a);P=!1};k.pop=function(){P=!0;this.w.remove(this.length-1);var a=this.D.pop();P=!1;return a};k.shift=function(){P=!0;this.w.remove(0);var a=this.D.shift();P=!1;return a};k.concat=function(a){for(var b=a.length,c=0;c<b;c++)this.push(a[c]);return this};k.sort=L.sort;k.reverse=L.reverse;k.slice=L.slice;k.map=function(a,b){b&&(a=a.bind(this));b=0;for(var c=this.length;b<c;b++)this[b]=a(this[b]);return this};
...
k.search=function(a){a=Object.values(a).join("^");for(var b=0;b<this.length;b++)if(Object.values(this.data(b)).join("^")===a)return this.b[b]};k.where=function(a){for(var b=Object.keys(a),c=b.length,d=[],e=0,f,g;e<this.length;e++){f=this.data(e);g=1;for(var h=0,l;h<c;h++)if(l=b[h],f[l]!==a[l]){g=0;break}g&&(d[d.length]=this.b[e])}return d};
k.init=function(a,b){"string"===typeof a?a=Q[a]:(b||!a||a.n||(b=a,a=null),a?a.n&&Ba(a):a=Q[this.l]);b||(b=this.N||{});this.H=!1!==b.reuse;this.state=b.state||za;this.cache=!1!==b.cache;this.async=b.async;this.C=0;this.I=b.on;var c=b.store||!1!==b.store;(this.J="object"===typeof c)?b.store=!0:c&&(c=[]);if(this.observe=c instanceof O)c.w=this;this.K=0;this.B=!this.J&&!1!==b.loose;this.store=!this.B&&c;this.N=b;c=a.n;this.l!==c&&(this.l=c,this.F=a.d,this.G=this.o=null,this.proxy=this.A=0,this.include=
null,this.L=!1!==b.prefetch&&U(this,a),Ca(this),this.g=(this.key=a.k)&&{},a=b.pool,this.v=this.H&&!1!==a&&"key"!==a&&(S[c]||(S[c]=[])),this.u=this.key&&!1!==a&&"queue"!==a&&(T[c]||(T[c]={})),this.size=this.v&&b.size);return this};G.once=function(a,b,c,d,e){var f=new G(a,b);"function"===typeof d&&(e=d,d=null);if(e){var g=e;e=function(){f.destroy(1);g()}}f.render(c,d,e);e||f.destroy(1);return G};function Ca(a){if(a.root){var b=a.root._t;b!==a.l&&(a.root._t=a.l,b&&(a.g={},a.remove(0,a.length)))}}
function Da(a){for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=a[d],c[d]=e;return c}k=G.prototype;
k.create=function(a,b,c){var d=this.key,e=d&&a[d],f,g;if(d&&(g=this.u)&&(f=g[e])){var h=1;if(g){if(g[e]=null,g=this.v){var l=f._n;f._n=null;var n=g.pop();n!==f&&(n._n=l,g[l]=n)}}else d=0}else if((f=this.v)&&f.length)f=f.pop(),g&&(f._n=null,g[f._k]=null);else{var y=1;f=this.L}h&&this.A&&!this.observe||this.apply(f,a,b,c);if(y){f=f.cloneNode(!0);var v;(v=this.I)&&(v=v.create)&&v(f)}d&&(f._k=e,this.g[e]=f);return f};
k.apply=function(a,b,c,d){this.L||(this.L=a=U(this,Q[this.l]));if(!this.F){b||(b=this.store?this.store[d]:a._m);c&&this.observe&&(this.store.view=c);this.G(a._p||Ea(this,a),!1,b,d,c);var e;(e=this.I)&&(e=e.change)&&a!==this.L&&e(a);return this}};
...
k.render=function(a,b,c,d){if(!d){b&&"object"!==typeof b&&(c=b,b=null);this.C&&this.cancel();if(c){var e=this;this.C=xa(function(){e.C=0;e.render(a,b,null,1);"function"===typeof c&&c()});return this}if(this.async){var f=this;return new Promise(function(p){f.C=xa(function(){f.C=0;f.render(a,b,null,1);p()})})}}d=this.length;if(!a){if(this.F)return this.b[0]||this.add(),this;if(!(a=this.store))return this}var g=a.length;if("undefined"===typeof g)a=[a],g=1;else if(!g)return this.remove(0,d);var h=(this.u||
!this.H)&&this.key;h||this.H||(this.remove(0,d,g),d=0);var l=d<g?d:g,n=0;if(n<l)for(;n<l;n++){var y=this.b[n],v=a[n];if(h&&y._k!==v[h])return this.reconcile(a,b,n,1);this.update(y,v,b,n)}if(n<g)for(;n<g;n++)this.add(a[n],b);else g<d&&this.remove(g,d-g);return this};
k.reconcile=function(a,b,c,d){var e=!this.J&&this.store;e&&(a||(a=e),this.store=0);var f=this.b,g=this.g,h=a.length,l=f.length,n=l>h?l:h,y=0,v=this.key;for(c||(c=0);c<n;c++){var p=void 0;if(c<h){var r=a[c],q=c>=l,t=void 0,A=void 0,x=void 0;if(!q&&(t=f[c],A=r[v],x=t._k,x===A)){d&&this.update(t,r,b,c);continue}if(q||!g[A]){d&&(q||!this.u?(l++,n=l>h?l:h,this.add(r,b,c)):this.replace(t,r,b,c));continue}for(var z=q=void 0,u=c+1;u<n;u++)if(!q&&u<l&&f[u]._k===A&&(q=u+1),!z&&u<h&&a[u][v]===x&&(z=u+1),q&&
z){q>=z?(p=f[q-1],this.root.insertBefore(p,t),d&&this.update(p,r,b,c),q===z?(1<u-c&&this.root.insertBefore(t,f[q]),f[c]=f[u],f[u]=t):(V(f,q-1,c),y++)):(r=z-1+y,this.root.insertBefore(t,f[r]||null),V(f,c,(r>l?l:r)-1),y--,c--);p=1;break}}p||(this.remove(c),l--,n=l>h?l:h,c--)}e&&(this.store=a);return this};function V(a,b,c,d){var e=d||a[b];d&&b++;if(b<c)for(;b<c;b++)a[b]=a[b+1];else for(;b>c;b--)a[b]=a[b-1];a[c]=e}
k.add=function(a,b,c,d){if(!d)if("number"===typeof b){c=b;b=null;var e=1}else if(c||0===c)e=1;c=d||e?c:this.length;b=this.create(a,b,c);var f;this.proxy&&(this.A&&this.B&&b._m===a?f=1:a._y||(a=ta(a,b._p||Ea(this,b),this.proxy)));f||(this.store?e&&!this.J?V(this.store,this.length-1,c,a):(this.K=1,this.store[c]=a,this.K=0):this.B&&(b._m=a));e?(this.root.insertBefore(b,this.b[c]),V(this.b,this.length-1,c,b),this.length++):(d?this.root.replaceChild(b,d):(this.root.appendChild(b),this.length++),this.b[c]=
b);var g;(g=this.I)&&(g=g.insert)&&g(b);return this};k.clear=function(a){this.length&&this.remove(0,this.length);if(a){R[this.l+(this.cache?"$":"")]=null;if(this.key)if(this.length){a=Object.keys(this.g);for(var b=0,c=a.length,d=void 0;b<c;b++)this.key[d=a[b]]||delete this.key[d]}else this.g={};this.v&&(this.v=S[this.l]=[]);this.u&&(this.u=T[this.l]={})}return this};k.destroy=function(a){a&&this.unload();this.length=0;this.include=this.store=this.g=this.b=this.root=this.l=this.o=this.G=this.L=null};
k.cancel=function(){this.C&&(ya(this.C),this.C=null);return this};k.append=function(a,b,c){if("number"===typeof b){c=b;b=null;var d=1}else d=c||0===c;for(var e=a.length,f=0;f<e;f++)this.add(a[f],b,d?c++:null);return this};
k.remove=function(a,b,c){var d=this.length;a&&("object"===typeof a?a=this.index(a):0>a&&(a=d+a-1));if(!d||a>=d)return this;b?0>b&&(a-=b+1,0>a&&(a=0),b*=-1):b=1;if(!a&&b>=d){this.store&&!this.J&&(this.store=c?Array(c):[]);if(this.include&&(this.u||this.v))for(b=0;b<this.include.length;b++)this.include[b].clear();a=this.b;b=a.length;this.root.textContent="";this.root._d=this.b=c?Array(c):[];d=0}else this.store&&!this.observe&&this.store.splice(a,b),a=this.b.splice(a,b),d-=b;var e;if((e=this.I)&&(e=
...
k.replace=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[d]):d=this.index(a));this.add(b,c,d,a);Fa(this,a);var e;(e=this.I)&&(e=e.remove)&&e(a);return this};
k.update=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[a]):d=this.index(a));if(this.proxy){if(this.A&&(this.store?this.store[d]:a._m)===b)return this;b._y||(b=ta(b,a._p||Ea(this,a),this.proxy))}this.store?(this.K=1,this.store[d]=b,this.K=0):this.B&&(a._m=b);if(this.key){var e=a._k,f=b[this.key];e!==f&&(this.g[e]=null,this.g[f]=a,a._k=f)}var g;(g=this.I)&&(g=g.update)&&g(a);return this.apply(a,b,c,d)};
function Ea(a,b){for(var c=a.o.length,d={},e=Array(c),f=0,g;f<c;f++){g=a.o[f];var h=f,l;if(!(l=d[g])){l=b;for(var n=0,y=g.length,v="";n<y;n++){var p=g[n];v+=p;d[v]?l=d[v]:(">"===p?l=l.firstElementChild:"+"===p?l=l.nextElementSibling:"|"===p&&(l=l.firstChild),d[v]=l)}}e[h]=l}return b._p=e}var W;
function U(a,b,c,d,e){if(!c){var f=R[b.n+(a.cache?"$":"")];if(f)return a.G=f.G,a.F=f.F,a.A=f.A,a.proxy=f.proxy,a.include=f.O,a.o=f.o,f.node}f=document.createElement(b.t||"div");c||(c=0,d="&",W="",a.o=[],f._p=e=[]);var g=b.s,h=b.i,l=b.x,n=b.h,y=b.a,v=b.e,p=b.c,r=b.j,q=a.o.length,t=0,A=0,x="";r&&(x+=";"+r,-1<x.indexOf("self")&&(t=2));b.f&&(W+=";if("+b.f+"){self.hidden=false",t=2);p&&("object"===typeof p?(r=p[1],p=""+p[0],x+=a.cache&&!r?";v="+p+";if(self._c!==v){self._c=v;self.className=v}":p?";self.className="+
...
u,["_a",q,r]),A++);t++}else f.setAttribute(r,u)}}g&&("string"===typeof g?f.style.cssText=g:g.length&&(z=g[1],g=g[0],x+=a.cache&&!z?";v="+g+";if(self._cs!==v){self._cs=v;(self._s||(self._s=self.style)).cssText=v}":g?";self.style.cssText="+g:"",z&&(X(a,g,["_cs",q]),A++),t++));if(b["@"]||b.r){a.include||(a.include=[]);var B=b["@"]||b.i;b["@"]||(B.n=b["@"]=a.l+"@"+a.include.length,b.i=null);h=null;x+=";this.include["+a.include.length+"].mount(self).render("+b.r+(b.m?".slice("+(0<=b.m?"0,"+b.m:b.m)+")":
"")+",view)";l=W;W="";a.include.push(new G(f,B,Object.assign({},a.N,{store:!1,async:0})));W=l;t++}else if(!h)if(b["+"])h=Q[b["+"]];else if(l){if(n="object"===typeof l)B=l[1],l=""+l[0];g=document.createTextNode(l);n&&(t&&q++,a.o[q]=d+"|",e[q]=g,Ga(t,a.cache&&!B?";v="+l+";if(self._x!==v){self._x=v;self.nodeValue=v}":l?";self.nodeValue="+l:"",q,a.cache),B&&(X(a,l,["_x",q]),A++),t&&q--);f.appendChild(g)}else n&&("object"===typeof n?(B=n[1],n=""+n[0],x+=a.cache&&!B?";v="+n+";if(self._h!==v){self._h=v;self.innerHTML=v}":
n?";self.innerHTML="+n:"",B&&(X(a,n,["_h",q]),A++),t++):f.innerHTML=n);t?(a.o[q]=d,e[q]=f,a.F=0,t===A&&(a.A=1),Ga(t,x,q,a.cache)):x&&(W+=x);if(h)if(h.length)for(x=">",B=0;B<h.length;B++){B&&(x+="+");l=h[B];if(A=l["+"])l=Q[A];f.appendChild(U(a,l,c+B+1,d+x,e))}else{if(A=h["+"])h=Q[A];f.appendChild(U(a,h,c+1,d+">",e))}b.f&&(W+="}else "+(1<t?"self":"p["+q+"]")+".hidden=true");c||(!a.F&&W&&(a.G=Function("p","s","data","index","view",'"use strict";var self,v'+W)),c={G:a.G,F:a.F,o:a.o,node:f},c.O=a.include,
c.proxy=a.proxy,c.A=a.A,R[b.n+(a.cache?"$":"")]=c);return f}function X(a,b,c){a.proxy||(a.proxy={});(a.proxy[b]||(a.proxy[b]=[])).push(c)}function Ga(a,b,c,d){W=d||1<a?W+(";self=p["+c+"]"+b):W+b.replace(/self/g,"p["+c+"]")}
