 ...
 */
(function(){'use strict';var k;function l(a,b,c,d){if("tap"===b){if(x||B){aa(a);return}ba=!0;b="click"}window[(a?"add":"remove")+"EventListener"](b,c,d||{passive:!0,capture:!0})}
...
k.init=function(a,b){"string"===typeof a?a=Q[a]:(b||!a||a.n||(b=a,a=null),a?a.n&&ya(a):a=Q[this.l]);b||(b=this.N||{});this.H=!1!==b.reuse;this.state=b.state||xa;this.cache=!1!==b.cache;this.async=b.async;this.C=0;this.J=b.on;var c=b.store||!1!==b.store;(this.L="object"===typeof c)?b.store=!0:c&&(c=[]);if(this.observe=c instanceof N)c.v=this;this.K=0;this.B=!this.L&&!1!==b.loose;this.store=!this.B&&c;this.N=b;c=a.n;this.l!==c&&(this.l=c,this.F=a.d,this.G=this.u=null,this.proxy=this.w=0,this.include=
null,this.I=!1!==b.prefetch&&U(this,a),za(this),this.g=(this.key=a.k)&&{},this.o=this.H&&!1!==b.pool&&(S[c]||(S[c]=[])),this.A=this.key&&(b.keep||this.o)&&(T[c]||(T[c]={})),this.size=this.o&&b.size);return this};F.once=function(a,b,c,d,e){var f=new F(a,b);"function"===typeof d&&(e=d,d=null);if(e){var g=e;e=function(){f.destroy(1);g()}}f.render(c,d,e);e||f.destroy(1);return F};function za(a){if(a.root){var b=a.root._t;b!==a.l&&(a.root._t=a.l,b&&(a.key&&(a.g={}),a.length=0,a.remove(0,a.length)))}}
function Aa(a){for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=a[d],e._i=d,c[d]=e;return c}k=F.prototype;
k.create=function(a,b,c){var d=this.key,e=d&&a[d],f,g;if(d&&((g=this.A)&&(f=g[e])||(f=this.g[e]))){var h=1;if(g){if(g[e]=null,g=this.o){var m=f._n;f._n=null;var n=g.pop();n!==f&&(n._n=m,g[m]=n)}}else d=0}else if((f=this.o)&&f.length)f=f.pop(),g&&(f._n=null,g[f._k]=null);else{var y=1;f=this.I}h&&this.w&&!this.observe||this.apply(f,a,b,c);if(y){f=this.I.cloneNode(!0);var r;(r=this.J)&&(r=r.create)&&r(f)}d&&(f._k=e,this.g[e]=f);return f};
...
c?(this.root.insertBefore(t,e[v]||null),t._i=q,e[c]=e[q],e[q]=t,d&&this.update(t,a[q],b,q)):(W(e,v-1,c),n++,u=1)):(u=z-1+n,this.root.insertBefore(t,e[u]),W(e,c,(u>h?h:u)-1),u=1,n--,c--);r=1;break}}r||(this.remove(c,1,0,1),u=1,h--,m=h>g?h:g,c--)}return this};function W(a,b,c,d,e){if(e&&!b)return[a.shift()];var f=d||a[b];d&&b++;if(b<c)for(;b<c;b++)a[b]=a[b+1];else for(;b>c;b--)a[b]=a[b-1];if(e)return a.pop(),[f];a[c]=f}
k.add=function(a,b,c,d,e){if(!d)if("number"===typeof b){c=b;b=null;var f=1}else if(c||0===c)f=1;c=d||f?c:this.length;b=this.create(a,b,c);var g;this.proxy&&(this.w&&this.B&&b._m===a?g=1:a._y||(a=ra(a,b._p||V(this,b),this.proxy)));g||(this.store?f&&!this.L?W(this.store,this.length-1,c,a):(this.K=1,this.store[c]=a,this.K=0):this.B&&(b._m=a));b._i=c;if(f){if(this.root.insertBefore(b,this.b[c]||null),W(this.b,this.length-1,c,b),this.length++,!e)for(;++c<this.length;)this.b[c]._i=c}else d?this.root.replaceChild(b,
...
k.update=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[a]):d=a._i);if(this.proxy){if(this.w&&(this.store?this.store[d]:a._m)===b)return this;b._y||(b=ra(b,a._p||V(this,a),this.proxy))}this.store?(this.K=1,this.store[d]=b,this.K=0):this.B&&(a._m=b);if(this.key){var e=a._k,f=b[this.key];e!==f&&(this.g[e]=null,this.g[f]=a,a._k=f)}var g;(g=this.J)&&(g=g.update)&&g(a);return this.apply(a,b,c,d)};
function V(a,b){for(var c=a.u.length,d={},e=Array(c),f=0,g;f<c;f++){g=a.u[f];var h=f,m;if(!(m=d[g])){m=b;for(var n=0,y=g.length,r="";n<y;n++){var p=g[n];r+=p;d[r]?m=d[r]:(">"===p?m=m.firstElementChild:"+"===p?m=m.nextElementSibling:"|"===p&&(m=m.firstChild),d[r]=m)}}e[h]=m}a.cache&&(b.$={});return b._p=e}var X;
