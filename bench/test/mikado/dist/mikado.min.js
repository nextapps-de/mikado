 ...
 */
(function(){'use strict';var k;function l(a,b,c,d){if("tap"===b){if(x||C){aa(a);return}ba=!0;b="click"}window[(a?"add":"remove")+"EventListener"](b,c,d||!1)}
...
k.create=function(a,b,c){var d=this.key,e=d&&a[d],f,g,h;if(d&&(g=this.u)&&(f=g[e])){var m=1;if(g){if(g[e]=null,g=this.v){var n=f._n;f._n=null;var w=g.pop();w!==f&&(w._n=n,g[n]=w)}}else d=0}else(f=this.v)&&f.length?(f=f.pop(),g&&(f._n=null,g[f._k]=null)):f=h=this.N||(this.N=U(this,Q[this.l]));m&&this.B&&!this.observe||this.apply(f,a,b,c);if(h){f=f.cloneNode(!0);var v;(v=this.J)&&(v=v.create)&&v(f)}d&&(f._k=e,this.g[e]=f);return f};
k.apply=function(a,b,c,d){if(!this.G){b||(b=this.store?this.store[d]:a._m);c&&this.observe&&(this.store.view=c);this.H(a._p||Ea(this,a),!1,b,d,c);var e;(e=this.J)&&(e=e.change)&&a!==this.N&&e(a);return this}};k.refresh=function(a,b){if(this.B)return this;var c;"number"===typeof a?c=this.b[a]:b=a;if(c)return this.apply(c,null,b,a);a=this.length;if((c=this.store)&&this.C)return this.store=null,this.render(c,b);c=c?c.length:a;a=a<c?a:c;for(c=0;c<a;c++)this.apply(this.b[c],null,b,c);return this};
...
!this.I)&&this.key;h||this.I||(this.remove(0,d,g),d=0);var m=d<g?d:g,n=0;if(n<m)for(;n<m;n++){var w=this.b[n],v=a[n];if(h&&w._k!==v[h])return this.reconcile(a,b,n,1);this.update(w,v,b,n)}if(n<g)for(;n<g;n++)this.add(a[n],b);else g<d&&this.remove(g,d-g);return this};
k.reconcile=function(a,b,c,d){var e=!this.K&&this.store;e&&(a||(a=e),this.store=0);var f=this.b,g=this.g,h=a.length,m=f.length,n=m>h?m:h,w=0,v=this.key;for(c||(c=0);c<n;c++){var p=void 0;if(c<h){var r=a[c],q=c>=m,t=void 0,A=void 0,y=void 0;if(!q&&(t=f[c],A=r[v],y=t._k,y===A)){d&&this.update(t,r,b,c);continue}if(q||!g[A]){d&&(q||!this.u?(m++,n=m>h?m:h,this.add(r,b,c)):this.replace(t,r,b,c));continue}for(var z=q=void 0,u=c+1;u<n;u++)if(!q&&u<m&&f[u]._k===A&&(q=u+1),!z&&u<h&&a[u][v]===y&&(z=u+1),q&&
...
function Ea(a,b){for(var c=a.o.length,d={},e=Array(c),f=0,g;f<c;f++){g=a.o[f];var h=f,m;if(!(m=d[g])){m=b;for(var n=0,w=g.length,v="";n<w;n++){var p=g[n];v+=p;d[v]?m=d[v]:(">"===p?m=m.firstElementChild:"+"===p?m=m.nextElementSibling:"|"===p&&(m=m.firstChild),d[v]=m)}}e[h]=m}return b._p=e}var W;
function U(a,b,c,d,e){if(!c){var f=R[b.n+(a.cache?"$":"")];if(f)return a.H=f.H,a.G=f.G,a.B=f.B,a.proxy=f.proxy,a.include=f.P,a.o=f.o,f.node}f=document.createElement(b.t||"div");c||(c=0,d="&",W="",a.o=[],f._p=e=[]);var g=b.s,h=b.i,m=b.x,n=b.h,w=b.a,v=b.e,p=b.c,r=b.j,q=a.o.length,t=0,A=0,y="";r&&(y+=";"+r,-1<y.indexOf("self")&&(t=2));b.f&&(W+=";if("+b.f+"){self.hidden=false",t=2);p&&("object"===typeof p?(r=p[1],p=""+p[0],y+=a.cache&&!r?";v="+p+";if(self._c!==v){self._c=v;self.className=v}":p?";self.className="+
...
"")+",view)";m=W;W="";a.include.push(new G(f,B,Object.assign({},a.O,{store:!1,async:0})));W=m;t++}else if(!h)if(b["+"])h=Q[b["+"]];else if(m){if(n="object"===typeof m)B=m[1],m=""+m[0];g=document.createTextNode(m);n&&(t&&q++,a.o[q]=d+"|",e[q]=g,Ga(t,a.cache&&!B?";v="+m+";if(self._x!==v){self._x=v;self.nodeValue=v}":m?";self.nodeValue="+m:"",q,a.cache),B&&(X(a,m,["_x",q]),A++),t&&q--);f.appendChild(g)}else n&&("object"===typeof n?(B=n[1],n=""+n[0],y+=a.cache&&!B?";v="+n+";if(self._h!==v){self._h=v;self.innerHTML=v}":
n?";self.innerHTML="+n:"",B&&(X(a,n,["_h",q]),A++),t++):f.innerHTML=n);t?(a.o[q]=d,e[q]=f,a.G=0,t===A&&(a.B=1),Ga(t,y,q,a.cache)):y&&(W+=y);if(h)if(h.length)for(y=">",B=0;B<h.length;B++){B&&(y+="+");m=h[B];if(A=m["+"])m=Q[A];f.appendChild(U(a,m,c+B+1,d+y,e))}else{if(A=h["+"])h=Q[A];f.appendChild(U(a,h,c+1,d+">",e))}b.f&&(W+="}else "+(1<t?"self":"p["+q+"]")+".hidden=true");c||(!a.G&&W&&(a.H=Function("p","s","data","index","view",'"use strict";var self,v'+W)),c={H:a.H,G:a.G,o:a.o,node:f},c.P=a.include,
