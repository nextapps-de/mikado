...
!1, SUPPORT_EVENTS$$module$tmp$config = !1, SUPPORT_WEB_COMPONENTS$$module$tmp$config = !1, MIKADO_NODE_CACHE$$module$tmp$config = "_mkc", MIKADO_DOM$$module$tmp$config = "_mkd", MIKADO_CLASS$$module$tmp$config = "_mki", MIKADO_TPL_KEY$$module$tmp$config = "_mkk", MIKADO_LIVE_POOL$$module$tmp$config = "_mkl", MIKADO_TPL_PATH$$module$tmp$config = "_mkp", MIKADO_PROXY$$module$tmp$config = "_mkx", MIKADO_EVENT_CACHE$$module$tmp$config = "_mke";
...
RELEASE:RELEASE$$module$tmp$config, SUPPORT_ASYNC:SUPPORT_ASYNC$$module$tmp$config, SUPPORT_CACHE:SUPPORT_CACHE$$module$tmp$config, SUPPORT_CACHE_HELPERS:SUPPORT_CACHE_HELPERS$$module$tmp$config, SUPPORT_CALLBACKS:SUPPORT_CALLBACKS$$module$tmp$config, SUPPORT_COMPILE:SUPPORT_COMPILE$$module$tmp$config, SUPPORT_DOM_HELPERS:SUPPORT_DOM_HELPERS$$module$tmp$config, SUPPORT_EVENTS:SUPPORT_EVENTS$$module$tmp$config, SUPPORT_KEYED:SUPPORT_KEYED$$module$tmp$config, SUPPORT_POOLS:SUPPORT_POOLS$$module$tmp$config, 
SUPPORT_REACTIVE:SUPPORT_REACTIVE$$module$tmp$config, SUPPORT_WEB_COMPONENTS:SUPPORT_WEB_COMPONENTS$$module$tmp$config};
...
function resolve$$module$tmp$factory(a, b, c) {
  ...
  for (let e = 0, f = b.length, h = ""; e < f; e++) {
    const g = b[e];
    h += g;
    c[h] ? a = c[h] : (">" === g ? a = a.firstChild : "|" === g ? (d = a, a = a.firstChild) : "@" === g ? (d = a, a = a.style) : a = a.nextSibling, c[h] = a);
  }
  return [a, d];
}
function construct$$module$tmp$factory(a, b, c, d, e, f) {
  ...
  let g, k;
  if (k = b.class) {
    "object" === typeof k ? (PROFILER$$module$tmp$config && tick$$module$tmp$profiler("cache.create"), c.push(new Cache$$module$tmp$factory(g = {_c:""}, h, d)), SUPPORT_REACTIVE$$module$tmp$config && ((k = k[0]) ? init_proxy$$module$tmp$factory(a, k, ["_c", c.length - 1]) : a.fullproxy = 0)) : e || (h.className = k);
  }
  if (k = b.attr) {
    for (const m in k) {
      let n = k[m];
      "object" === typeof n ? (PROFILER$$module$tmp$config && tick$$module$tmp$profiler("cache.create"), g || c.push(new Cache$$module$tmp$factory(g = {}, h, d)), g["_a" + m] = !1, SUPPORT_REACTIVE$$module$tmp$config && ((n = n[0]) ? init_proxy$$module$tmp$factory(a, n, ["_a", c.length - 1, m]) : a.fullproxy = 0)) : e || h.setAttribute(m, n);
    }
  }
  ...
  if (k = b.style) {
    "object" === typeof k ? (PROFILER$$module$tmp$config && tick$$module$tmp$profiler("cache.create"), c.push(new Cache$$module$tmp$factory(g || (g = {}), h.style, d + "@")), g._s = "", SUPPORT_REACTIVE$$module$tmp$config && ((k = k[0]) ? init_proxy$$module$tmp$factory(a, k, ["_s", c.length - 1]) : a.fullproxy = 0)) : e || (h.style.cssText = k);
  }
  if (k = b.text) {
    if ("object" === typeof k) {
      var l = h;
      ...
      SUPPORT_REACTIVE$$module$tmp$config && (k ? init_proxy$$module$tmp$factory(a, k, ["_t", c.length - 1]) : a.fullproxy = 0);
    } else {
    ...
    "object" === typeof k ? (PROFILER$$module$tmp$config && tick$$module$tmp$profiler("cache.create"), g || c.push(new Cache$$module$tmp$factory(g = {}, h, d)), g._h = "", SUPPORT_REACTIVE$$module$tmp$config && ((k = k[0]) ? init_proxy$$module$tmp$factory(a, k, ["_h", c.length - 1]) : a.fullproxy = 0)) : e || (h.innerHTML = k);
  } else if (k = b.inc) {
    PROFILER$$module$tmp$config && tick$$module$tmp$profiler("cache.create");
...
let MikadoOptions$$module$tmp$type, Template$$module$tmp$type, TemplateDOM$$module$tmp$type, EventOptions$$module$tmp$type, NodeCache$$module$tmp$type, ProxyHandler$$module$tmp$type, MikadoCallbacks$$module$tmp$type;
var module$tmp$type = {};
