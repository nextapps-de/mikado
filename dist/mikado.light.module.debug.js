...
n.replace = function(a, b, c, e) {
  ...
  h ? !this.apply || this.apply(b, c || this.state, e, h._mkp || q(h, this.h._mkp, this.cache)) : (b = this.create(b, c, e, 1), (this.key || this.pool) && G(this, a), this.g[e] = b, a.replaceWith(b));
  return this;
};
