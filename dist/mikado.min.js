 ...
 */
(function(){'use strict';var k;function l(a,b,c,d){if("tap"===b){if(v||A){aa(a);return}ba=!0;b="click"}window[(a?"add":"remove")+"EventListener"](b,c,d||{passive:!0,capture:!0})}
...
var E={},da={},ca=document.body,v="ontouchstart"in window,A=!v&&window.PointerEvent&&navigator.maxTouchPoints,ba;F.route=F.prototype.route=function(a,b){da[a]=b;return this};var G,H,aa;if(v||A){var ea=function(a,b){b&&(a=b[0]);G=a.clientX;H=a.clientY},fa=function(a){var b=G,c=H;ea(a,a.changedTouches);50>Math.abs(G-b)&&50>Math.abs(H-c)&&C.call(this,a,"tap")},ha=function(a){ea(a,a.touches)};aa=function(a){l(a,A?"pointerdown":"touchstart",ha,!1);l(a,A?"pointerup":"touchend",fa,!1)}}
F.listen=F.prototype.listen=function(a,b){E[a]||(l(1,a,C,b||!0),E[a]=1);return this};F.unlisten=F.prototype.unlisten=function(a,b){E[a]&&(l(0,a,C,b||!0),E[a]=0);return this};k=F.prototype;k.move=function(a,b){if("number"===typeof a){var c=a;a=this.b[c]}else c=a._i;0>b&&(b=this.length+b-1);c!==b&&this.shift(a,b-c);return this};
...
var P=!1,na={set:function(a,b,c){if("number"===typeof b)var d=!0;else{var e=parseInt(b,10);b===""+e&&(b=e,d=!0)}if(!P){P=!0;if((e=a.v)&&!e.K){var f=a.length;if(d){var g=e.length;f!==g&&(a.length=g);if(e.w&&a[b]===c)return P=!1,!0;d=a.view;b>=g?(e.add(c,d),a.length++):b<g&&(f=e.key,g=e.b[b],e.H||f&&g._k===c[f]?e.update(g,c,d,b):e.replace(g,c,d,b));if(e.proxy)return P=!1,!0}else"length"===b&&c<f&&e.remove(c,f-c)}P=!1}(L?a:a.D)[b]=c;return!0}};k=N.prototype;
...
k.init=function(a,b){"string"===typeof a?a=Q[a]:(b||!a||a.n||(b=a,a=null),a?a.n&&ya(a):a=Q[this.l]);b||(b=this.N||{});this.H=!1!==b.reuse;this.state=b.state||xa;this.cache=!1!==b.cache;this.async=b.async;this.C=0;this.J=b.on;var c=b.store||!1!==b.store;(this.L="object"===typeof c)?b.store=!0:c&&(c=[]);if(this.observe=c instanceof N)c.v=this;this.K=!1;this.B=!this.L&&!1!==b.loose;this.store=!this.B&&c;this.N=b;c=a.n;this.l!==c&&(this.l=c,this.F=a.d,this.G=this.u=null,this.proxy=this.w=!1,this.include=
null,this.I=!1!==b.prefetch&&U(this,a),za(this),this.g=(this.key=a.k)&&{},this.o=this.H&&!1!==b.pool&&(S[c]||(S[c]=[])),this.A=this.key&&(b.keep||this.o)&&(T[c]||(T[c]={})),this.size=this.o&&b.size);return this};F.once=function(a,b,c,d,e){var f=new F(a,b);"function"===typeof d&&(e=d,d=null);if(e){var g=e;e=function(){f.destroy(!0);g()}}f.render(c,d,e);e||f.destroy(!0);return F};
function za(a){if(a.root){var b=a.root._t;b!==a.l&&(a.root._t=a.l,b&&(a.key&&(a.g={}),a.length=0,a.remove(0,a.length)))}}function Aa(a){for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=a[d],e._i=d,c[d]=e;return c}k=F.prototype;
k.create=function(a,b,c){var d=this.key,e=d&&a[d],f,g;if(d&&((g=this.A)&&(f=g[e])||(f=this.g[e]))){var h=!0;if(g){if(g[e]=null,g=this.o){var m=f._n;f._n=null;var n=g.pop();n!==f&&(n._n=m,g[m]=n)}}else d=!1}else if((f=this.o)&&f.length)f=f.pop(),g&&(f._n=null,g[f._k]=null);else{var z=1;f=this.I}h&&this.w&&!this.observe||this.apply(f,a,b,c);if(z){f=this.I.cloneNode(!0);var q;(q=this.J)&&(q=q.create)&&q(f)}d&&(f._k=e,this.g[e]=f);return f};
...
k.render=function(a,b,c,d){if(!d){b&&"object"!==typeof b&&(c=b,b=null);this.C&&this.cancel();if(c){var e=this;this.C=va(function(){e.C=0;e.render(a,b,null,!0);"function"===typeof c&&c()});return this}if(this.async){var f=this;return new Promise(function(p){f.C=va(function(){f.C=0;f.render(a,b,null,!0);p()})})}}d=this.length;if(!a){if(this.F)return this.b[0]||this.add(),this;if(d)return this.refresh();if(!(a=this.store))return this}var g=a.length;if("undefined"===typeof g)a=[a],g=1;else if(!g)return this.remove(0,
d);var h=(this.A||!this.H)&&this.key;h||this.H||(this.remove(0,d,g),d=0);var m=d<g?d:g,n=0;if(n<m)for(;n<m;n++){var z=this.b[n],q=a[n];if(h&&z._k!==q[h])return Ba(this,a,b,n);this.update(z,q,b,n)}if(n<g)for(;n<g;n++)this.add(a[n],b);else g<d&&this.remove(g,d-g);return this};function Ca(a,b,c){var d=a[b],e=b;if(b<c)for(;e<c;e++)a[e]=a[e+1];else for(;e>c;e--)a[e]=a[e-1];a[c]=d}
function Ba(a,b,c,d){for(var e=a.b,f=a.g,g=b.length,h=e.length,m=h>g?h:g,n=0,z=a.key;d<m;d++){var q=!1;if(d<g){var p=b[d],u=p[z];if(!f[u]||d>=h){h++;m=h>g?h:g;a.add(p,c,d,null,!0);continue}var r=e[d],w=r._k;if(w===u){r._i=d;a.update(r,p,c,d);continue}for(var x=void 0,t=void 0,y=d+1;y<m;y++)if(!x&&y<h&&e[y]._k===u&&(x=y+1),!t&&y<g&&b[y][z]===w&&(t=y+1),x&&t){x>=t?(q=e[x-1],a.root.insertBefore(q,r),Ca(e,x-1,d),q._i=d,a.update(q,p,c,d),n++):(p=t-1+n,a.root.insertBefore(r,e[p]),Ca(e,d,(p>h?h:p)-1),n--,
d--);q=!0;break}}q||(a.remove(d,1,0,!0),h--,m=h>g?h:g,d--)}return a}
k.add=function(a,b,c,d,e){if(!d)if("number"===typeof b){c=b;b=null;var f=!0}else if(c||0===c)f=!0;c=d||f?c:this.length;b=this.create(a,b,c);var g;this.proxy&&(this.w&&this.B&&b._m===a?g=!0:a._y||(a=ra(a,b._p||V(this,b),this.proxy)));g||(this.store?f&&!this.L?this.store.splice(c,0,a):(this.K=!0,this.store[c]=a,this.K=!1):this.B&&(b._m=a));b._i=c;if(f){if(this.root.insertBefore(b,this.b[c]||null),this.b.splice(c,0,b),this.length++,!e)for(;++c<this.length;)this.b[c]._i=c}else d?this.root.replaceChild(b,
...
k.destroy=function(a){a&&this.unload();this.I=this.G=this.u=this.l=this.root=this.b=null;this.length=0;this.g={};this.store=this.include=null};k.cancel=function(){this.C&&(wa(this.C),this.C=null)};k.append=function(a,b,c){if("number"===typeof b){c=b;b=null;var d=!0}else d=c||0===c;for(var e=a.length,f=0;f<e;f++)this.add(a[f],b,d?c++:null);return this};
k.remove=function(a,b,c,d){var e=this.length;a&&("object"===typeof a?a=a._i:0>a&&(a=e+a-1));if(!e||a>=e)return this;0>b?(a-=b+1,0>a&&(a=0),b*=-1):b||(b=1);if(!a&&b>=e){this.store&&!this.observe&&(this.L?this.store.splice(0):this.store=c?Array(c):[]);if(this.include&&(this.A||this.o))for(b=0;b<this.include.length;b++)this.include[b].clear();var f=this.b;b=f.length;this.root.textContent="";this.root._d=this.b=c?Array(c):[];e=0}else this.store&&!this.observe&&this.store.splice(a,b),f=this.b.splice(a,
b),e-=b;var g;if((g=this.J)&&(g=g.remove))for(c=0;c<b;c++)g(f[c]);this.length=e;if(!d&&a<e)for(;a<e;a++)this.b[a]._i=a;if(this.o&&!this.A&&this.cache&&1<b){a=f;d=a.length;g=d/2|0;c=0;for(var h;c<g;c++)h=a[c],a[c]=a[d-c-1],a[d-c-1]=h}for(a=0;a<b;a++)d=f[a],e&&this.root.removeChild(d),Da(this,d);return this};function Da(a,b){if(a.key){var c=b._k;a.g[c]=null;a.A&&(a.A[c]=b)}a.o&&(c=a.o.length,!a.size||c<a.size)&&(a.A&&(b._n=c),a.o[c]=b)}
k.replace=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[d]):d=a._i);this.add(b,c,d,a);Da(this,a);var e;(e=this.J)&&(e=e.remove)&&e(a);return this};
k.update=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[a]):d=a._i);if(this.proxy){if(this.w&&(this.store?this.store[d]:a._m)===b)return this;b._y||(b=ra(b,a._p||V(this,a),this.proxy))}this.store?(this.K=!0,this.store[d]=b,this.K=!1):this.B&&(a._m=b);if(this.key){var e=a._k,f=b[this.key];e!==f&&(this.g[e]=null,this.g[f]=a,a._k=f)}var g;(g=this.J)&&(g=g.update)&&g(a);return this.apply(a,b,c,d)};
function V(a,b){for(var c=a.u.length,d={},e=Array(c),f=0,g;f<c;f++){g=a.u[f];var h=f,m;if(!(m=d[g])){m=b;for(var n=0,z=g.length,q="";n<z;n++){var p=g[n];q+=p;d[q]?m=d[q]:(">"===p?m=m.firstElementChild:"+"===p?m=m.nextElementSibling:"|"===p&&(m=m.firstChild),d[q]=m)}}e[h]=m}a.cache&&(b.$={});return b._p=e}var W;
function U(a,b,c,d,e){if(!c){var f=R[b.n+(a.cache?"$":"")];if(f)return a.G=f.G,a.F=f.F,a.w=f.w,a.proxy=f.proxy,a.include=f.O,a.u=f.u,f.node}f=document.createElement(b.t||"div");c||(c=0,d="&",W="",a.u=[],f._p=e=[],a.cache&&(f.$={}));var g=b.s,h=b.i,m=b.x,n=b.h,z=b.a,q=b.e,p=b.c,u=b.j,r=a.u.length,w=0,x=0,t="";u&&(t+=";"+u,-1<t.indexOf("self")&&(w=2));b.f&&(W+=";if("+b.f+"){self.hidden=false",w=2);p&&("object"===typeof p?(u=p[1],p=p[0],t+=a.cache?";v="+p+";if(self._c!==v){self._c=v;self.className=v}":
";self.className="+p,u&&(X(a,p,["_c",r]),x++),w++):f.className=p);if(z||q){var y;z&&(y=Object.keys(z));q&&(p=Object.keys(q),y=y?y.concat(p):p);for(p=0;p<y.length;p++){u=y[p];var D=void 0;z&&"undefined"!==typeof(D=z[u])||(D=q[u],a.listen(u));if("object"===typeof D){var Ja=D[1];D=D[0];t+=a.cache?";v="+D+";var _a=self._a||(self._a={});if(_a['"+u+"']!==v){_a['"+u+"']=v;self.setAttribute('"+u+"',v)}":";self.setAttribute('"+u+"',"+D+")";Ja&&(X(a,D,["_a",r,u]),x++);w++}else f.setAttribute(u,D)}}g&&("string"===
typeof g?f.style.cssText=g:g.length&&(y=g[1],g=g[0],t+=a.cache?";v="+g+";if(self._cs!==v){self._cs=v;(self._s||(self._s=self.style)).cssText=v}":";self.style.cssText="+g,y&&(X(a,g,["_cs",r]),x++),w++));if(b["@"]||b.r){a.include||(a.include=[]);var B=b["@"]||b.i;b["@"]||(B.n=b["@"]=a.l+"@"+a.include.length,b.i=null);h=null;t+=";this.include["+a.include.length+"].mount(self).render("+b.r+(b.m?".slice("+(0<=b.m?"0,"+b.m:b.m)+")":"")+",view)";m=W;W="";a.include.push(new F(f,B,Object.assign({},a.N,{store:!1,
async:!1})));W=m;w++}else if(!h)if(b["+"])h=Q[b["+"]];else if(m){if(n="object"===typeof m)B=m[1],m=m[0];g=document.createTextNode(m);n&&(w&&r++,a.u[r]=d+"|",e[r]=g,Ea(w,a.cache?";v="+m+";if(self._x!==v){self._x=v;self.nodeValue=v}":";self.nodeValue="+m,r,a.cache),B&&(X(a,m,["_x",r]),x++),w&&r--);f.appendChild(g)}else n&&("object"===typeof n?(B=n[1],n=n[0],t+=a.cache?";v="+n+";if(self._h!==v){self._h=v;self.innerHTML=v}":";self.innerHTML="+n,B&&(X(a,n,["_h",r]),x++),w++):f.innerHTML=n);w?(a.u[r]=d,
e[r]=f,a.F=!1,w===x&&(a.w=!0),Ea(w,t,r,a.cache)):t&&(W+=t);if(h)if(h.length)for(t=">",B=0;B<h.length;B++){B&&(t+="+");m=h[B];if(x=m["+"])m=Q[x];f.appendChild(U(a,m,c+B+1,d+t,e))}else{if(x=h["+"])h=Q[x];f.appendChild(U(a,h,c+1,d+">",e))}b.f&&(W+="}else "+(1<w?"self":"p["+r+"]")+".hidden=true");c||(!a.F&&W&&(a.G=Function("p","s","data","index","view",'"use strict";var self,v'+W)),c={G:a.G,F:a.F,u:a.u,node:f},c.O=a.include,c.proxy=a.proxy,c.w=a.w,R[b.n+(a.cache?"$":"")]=c);return f}
function X(a,b,c){a.proxy||(a.proxy={});(a.proxy[b]||(a.proxy[b]=[])).push(c)}function Ea(a,b,c,d){W=d||1<a?W+(";self=p["+c+"]"+b):W+b.replace(/self/g,"p["+c+"]")}F.prototype.load=function(a,b){var c=this,d=new XMLHttpRequest;d.overrideMimeType("application/json");d.open("GET",a,!1!==b);d.onload=function(){var e=this.responseText;if(e){try{var f=JSON.parse(e);ya(f);c instanceof F&&c.init(f)}catch(h){var g=h}"function"===typeof b&&b(g)}};d.send();return this};F.load=F.prototype.load;
F.prototype.unload=function(a){a?"object"===typeof a&&(a=a.n):a=this.l;a&&(Q[a]=null,S[a]=T[a]=R[a]=null,R[a+"$"]=null);return this};F.unregister=F.unload=F.prototype.unload;var Fa={tap:1,change:1,click:1,dblclick:1,input:1,keydown:1,keypress:1,keyup:1,mousedown:1,mouseenter:1,mouseleave:1,mousemove:1,mouseout:1,mouseover:1,mouseup:1,mousewheel:1,touchstart:1,touchmove:1,touchend:1,reset:1,select:1,submit:1,toggle:1,blur:1,error:1,focus:1,load:1,resize:1,scroll:1},Y,Ga=0;
function Ha(a,b){var c={};if(!b){Y=!0;if("string"===typeof a)if(-1!==a.indexOf("<")){var d=document.createElement("div");d.innerHTML=a;a=d.firstElementChild;c.n=a.id||"tpl_"+Ga++}else c.n=a,a=document.getElementById(a);else c.n=a.id||"tpl_"+Ga++;a.content?a=a.content.firstElementChild:"TEMPLATE"===a.tagName&&(a=a.firstElementChild)}if(d=a.tagName){if("INCLUDE"===d)return b=a.getAttribute("from"),c["+"]=b?b:Ia(a.firstChild.nodeValue),c;"DIV"!==d&&(c.t=d.toLowerCase())}else return(b=a)&&(b=b.nodeValue)&&
