 ...
 */
(function(){'use strict';var k;function m(a,b,c,d){if("tap"===b){if(w||C){aa(a);return}ba=!0;b="click"}window[(a?"add":"remove")+"EventListener"](b,c,d||{passive:!0,capture:!0})}
...
function Ba(a){for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=a[d],c[d]=e;return c}k=G.prototype;
...
k.apply=function(a,b,c,d){this.I||(this.I=a=U(this,Q[this.l]));if(!this.F){b||(b=this.store?this.store[d]:a._m);c&&this.observe&&(this.store.view=c);this.G(a._p||Ca(this,a),!1,b,d,c);var e;(e=this.J)&&(e=e.change)&&a!==this.I&&e(a);return this}};
...
k.cancel=function(){this.C&&(wa(this.C),this.C=null);return this};k.append=function(a,b,c){if("number"===typeof b){c=b;b=null;var d=1}else d=c||0===c;for(var e=a.length,f=0;f<e;f++)this.add(a[f],b,d?c++:null);return this};
...
k.replace=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[d]):d=this.index(a));this.add(b,c,d,a);Da(this,a);var e;(e=this.J)&&(e=e.remove)&&e(a);return this};
...
function Ca(a,b){for(var c=a.o.length,d={},e=Array(c),f=0,g;f<c;f++){g=a.o[f];var h=f,l;if(!(l=d[g])){l=b;for(var n=0,y=g.length,v="";n<y;n++){var p=g[n];v+=p;d[v]?l=d[v]:(">"===p?l=l.firstElementChild:"+"===p?l=l.nextElementSibling:"|"===p&&(l=l.firstChild),d[v]=l)}}e[h]=l}return b._p=e}var W;
...
a.N,{store:!1,async:0})));W=l;t++}else if(!h)if(b["+"])h=Q[b["+"]];else if(l){if(n="object"===typeof l)B=l[1],l=""+l[0];g=document.createTextNode(l);n&&(t&&q++,a.o[q]=d+"|",e[q]=g,Ea(t,a.cache&&!B?";v="+l+";if(self._x!==v){self._x=v;self.nodeValue=v}":l?";self.nodeValue="+l:"",q,a.cache),B&&(X(a,l,["_x",q]),A++),t&&q--);f.appendChild(g)}else n&&("object"===typeof n?(B=n[1],n=""+n[0],x+=a.cache&&!B?";v="+n+";if(self._h!==v){self._h=v;self.innerHTML=v}":n?";self.innerHTML="+n:"",B&&(X(a,n,["_h",q]),
A++),t++):f.innerHTML=n);t?(a.o[q]=d,e[q]=f,a.F=0,t===A&&(a.A=1),Ea(t,x,q,a.cache)):x&&(W+=x);if(h)if(h.length)for(x=">",B=0;B<h.length;B++){B&&(x+="+");l=h[B];if(A=l["+"])l=Q[A];f.appendChild(U(a,l,c+B+1,d+x,e))}else{if(A=h["+"])h=Q[A];f.appendChild(U(a,h,c+1,d+">",e))}b.f&&(W+="}else "+(1<t?"self":"p["+q+"]")+".hidden=true");c||(!a.F&&W&&(a.G=Function("p","s","data","index","view",'"use strict";var self,v'+W)),c={G:a.G,F:a.F,o:a.o,node:f},c.O=a.include,c.proxy=a.proxy,c.A=a.A,R[b.n+(a.cache?"$":
