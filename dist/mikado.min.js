...
f.render=function(a,b,d,c){"function"===typeof b&&(d=b,b=null);if(!c){if(d){var e=this;U=L(function(){U=null;e.render(a,b,null,!0);"function"===typeof d&&d()});return this}if(this.async){var l=this;return new Promise(function(k){U=L(function(){U=null;l.render(a,b,null,!0);k()})})}}if(this.l)this.b[0]||this.add();else if(a||this.g){c=a?a.length:this.length;this.w||this.clear(c);for(var h=0;h<c;h++)h<this.length?this.update(this.b[h],a[h],b,h):this.add(a[h],b,this.root);if(c<this.length){this.store&&
...
function V(a,b){for(var d=a.f.length,c={},e=Array(d),l=0;l<d;l++){var h=a.f[l],m=l,k;if(!(k=c[h])){k=b;for(var q="",n=0;n<h.length;n++){var p=h[n];q+=p;c[q]?k=c[q]:(">"===p?k=k.firstElementChild:"+"===p?k=k.nextElementSibling:"|"===p&&(k=k.firstChild),c[q]=k)}}e[m]=k}return b._p=e}var W;
A.prototype.parse=function(a,b,d,c){var e=document.createElement(a.t||"div");b||(b=0,d="&",W="",this.f=[],e._p=c=[]);var l=a.s,h=a.i,m=a.x,k=a.h,q=a.a,n=a.c,p=a.j;a=this.f.length;var u=0,r="";p&&(r+=p+";");n&&("object"===typeof n?(r+=this.cache?"._l(self,"+n[0]+")":"self.className="+n[0]+";",this.f[a]=d,c[a]=e,this.l=!1,u++):e.className=n);if(q){n=Object.keys(q);for(p=0;p<n.length;p++){var w=n[p],B=q[w];if("object"===typeof B){r+=this.cache?"._a(self,'"+w+"',"+B[0]+")":"self.setAttribute('"+w+"',"+
B[0]+");";var y=!0;u++}else e.setAttribute(w,B);T[w]&&this.listen(w)}y&&(this.f[a]=d,c[a]=e,this.l=!1)}if(l)if("string"===typeof l)e.style.cssText=l;else if(l.length)r+=this.cache?"._c(self,"+l[0]+")":"self.style.cssText="+l[0]+";",this.f[a]=d,c[a]=e,this.l=!1,u++;else{q=Object.keys(l);for(y=0;y<q.length;y++)if(n=q[y],p=l[n],"object"===typeof p){r+=this.cache?"._s(self,'"+n+"',"+p[0]+")":"self.style.setProperty('"+n+"',"+p[0]+");";var Y=!0;u++}else e.style.setProperty(n,p);Y&&(this.f[a]=d,c[a]=e,
this.l=!1)}h||(m?(d+="|",(l="object"===typeof m)&&(m=m[0]),k=document.createTextNode(m),l&&(c[a]&&(X(u,r,a,this.cache),r="",a++),r+=this.cache?"._t(self,"+m+")":"self.nodeValue="+m+";",this.f[a]=d,c[a]=k,this.l=!1,u++),e.appendChild(k)):k&&("object"===typeof k?(k=k[0],r+=this.cache?"._h(self, "+k+")":"self.innerHTML="+k+";",this.f[a]=d,c[a]=e,this.l=!1,u++):e.innerHTML=k));X(u,r,a,this.cache);if(h)if(h.length)for(m=">",a=0;a<h.length;a++)a&&(m+="+"),e.appendChild(this.parse(h[a],b+a+1,d+m,c));else e.appendChild(this.parse(h,
