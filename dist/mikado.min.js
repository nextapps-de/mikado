...
function U(a,b,c,d,e){if(!c){var f=R[b.n+(a.cache?"$":"")];if(f)return a.B=f.B,a.v=f.v,a.include=f.J,a.proxy=f.proxy,a.g=f.g,f.node}f=document.createElement(b.t||"div");c||(c=0,d="&",V="",a.g=[],f._p=e=[],f.$={});var g=b.s,h=b.i,k=b.x,m=b.h,v=b.a,u=b.e,q=b.c,r=b.j,p=a.g.length,w=0,t="";r&&(t+=";"+r,-1<t.indexOf("self")&&(a.g[p]=d,e[p]=f,w=2));q&&("object"===typeof q?(r=q[1],q=q[0],t+=a.cache?";v="+q+";if(self._c!==v){self._c=v;self.className=v}":";self.className="+q,r&&(a.proxy||(a.proxy={}),a.proxy[q]||
...
p,r]));Q=!0;w++}else f.setAttribute(r,y)}Q&&(a.g[p]=d,e[p]=f)}g&&("string"===typeof g?f.style.cssText=g:g.length&&(C=g[1],g=g[0],t+=a.cache?";v="+g+";if(self._cs!==v){self._cs=v;(self._s||(self._s=self.style)).cssText=v}":";self.style.cssText="+g,C&&(a.proxy||(a.proxy={}),a.proxy[g]||(a.proxy[g]=[]),a.proxy[g].push(["_cs",p])),a.g[p]=d,e[p]=f,w++));if(b["@"]||b.r){a.include||(a.include=[]);var z=b["@"]||b.i;b["@"]?"string"===typeof z&&(z=P[z]):(z.n=b["@"]=a.o+"@"+a.include.length,delete b.i);h=null;
k=V+=";this.include["+a.include.length+"].mount(p["+p+"]).render("+b.r+(b.m?".slice("+(0<=b.m?"0,"+b.m:b.m)+")":"")+",view)";V="";a.include.push(new E(f,z,Object.assign(a.I,{store:!1,async:!1})));V=k;a.g[p]=d;e[p]=f;a.v=!1}else if(!h)if(b["+"])h=P[b["+"]];else if(k){d+="|";if(m="object"===typeof k)z=k[1],k=k[0];g=document.createTextNode(k);m&&(w&&(ta(w,t,p,a.cache),t="",p++),t+=a.cache?";v="+k+";if(self._x!==v){self._x=v;self.nodeValue=v}":";self.nodeValue="+k,z&&(a.proxy||(a.proxy={}),a.proxy[k]||
(a.proxy[k]=[]),a.proxy[k].push(["_x",p])),a.g[p]=d,e[p]=g,w++);f.appendChild(g)}else m&&("object"===typeof m?(z=m[1],m=m[0],t+=a.cache?";v="+m+";if(self._h!==v){self._h=v;self.innerHTML=v}":";self.innerHTML="+m,z&&(a.proxy||(a.proxy={}),a.proxy[m]||(a.proxy[m]=[]),a.proxy[m].push(["_h",p])),a.g[p]=d,e[p]=f,w++):f.innerHTML=m);b.f&&(V+=";if("+b.f+"){"+(1<w?"self":"p["+p+"]")+".hidden=false",w||(a.g[p]=d,e[p]=f,a.v=!1));w?(a.v=!1,ta(w,t,p,a.cache)):t&&(V+=t);if(h)if(h.length)for(z=">",k=0;k<h.length;k++){k&&
(z+="+");m=h[k];if(t=m["+"])m=P[t];f.appendChild(U(a,m,c+k+1,d+z,e))}else{if(t=h["+"])h=P[t];f.appendChild(U(a,h,c+1,d+">",e))}b.f&&(V+="}else "+(1<w?"self":"p["+p+"]")+".hidden=true");c||(!a.v&&V&&(a.B=Function("p","s","data","index","view",'"use strict";var self,v'+V)),c={B:a.B,v:a.v,g:a.g,node:f},c.J=a.include,c.proxy=a.proxy,R[b.n+(a.cache?"$":"")]=c);return f}function ta(a,b,c,d){V=d||1<a?V+(";self=p["+c+"]"+b):V+b.replace(/self/g,"p["+c+"]")}
