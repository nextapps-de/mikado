...
var P=!1,oa={set:function(a,b,c){if("number"===typeof b)var d=!0;else{var e=parseInt(b,10);b===""+e&&(b=e,d=!0)}if(!P){P=!0;if((e=a.w)&&!e.L){var f=a.length;if(d){var g=e.length;f!==g&&(a.length=g);if(e.A&&a[b]===c)return P=!1,!0;d=a.view;b>=g?(e.add(c,d),a.length++):b<g&&(f=e.key,g=e.b[b],e.H||f&&g._k===c[f]?e.update(g,c,d,b):e.replace(g,c,d,b));if(e.proxy)return P=!1,!0}else"length"===b&&c<f&&e.remove(c,f-c)}P=!1}(M?a:a.D)[b]=c;return!0}};k=O.prototype;
...
k.init=function(a,b){"string"===typeof a?a=Q[a]:(b||!a||a.n||(b=a,a=null),a?a.n&&Ba(a):a=Q[this.l]);b||(b=this.N||{});this.H=!1!==b.reuse;this.state=b.state||za;this.cache=!1!==b.cache;this.async=b.async;this.C=0;this.J=b.on;var c=b.store||!1!==b.store;(this.K="object"===typeof c)?b.store=!0:c&&(c=[]);if(this.observe=c instanceof O)c.w=this;this.L=0;this.B=!this.K&&!1!==b.loose;this.store=!this.B&&c;this.N=b;c=a.n;this.l!==c&&(this.l=c,this.F=a.d,this.G=this.o=null,this.proxy=this.A=0,this.include=
null,this.I=!1!==b.prefetch&&U(this,a),Ca(this),this.g=(this.key=a.k)&&{},a=b.pool,this.v=this.H&&!1!==a&&"key"!==a&&(S[c]||(S[c]=[])),this.u=this.key&&!1!==a&&"queue"!==a&&(T[c]||(T[c]={})),this.size=this.v&&b.size);return this};G.once=function(a,b,c,d,e){var f=new G(a,b);"function"===typeof d&&(e=d,d=null);if(e){var g=e;e=function(){f.destroy(1);g()}}f.render(c,d,e);e||f.destroy(1);return G};function Ca(a){if(a.root){var b=a.root._t;b!==a.l&&(a.root._t=a.l,b&&(a.g={},a.remove(0,a.length)))}}
function Da(a){for(var b=a.length,c=Array(b),d=0,e;d<b;d++)e=a[d],c[d]=e;return c}k=G.prototype;
k.create=function(a,b,c){var d=this.key,e=d&&a[d],f,g;if(d&&(g=this.u)&&(f=g[e])){var h=1;if(g){if(g[e]=null,g=this.v){var l=f._n;f._n=null;var n=g.pop();n!==f&&(n._n=l,g[l]=n)}}else d=0}else if((f=this.v)&&f.length)f=f.pop(),g&&(f._n=null,g[f._k]=null);else{var y=1;f=this.I}h&&this.A&&!this.observe||this.apply(f,a,b,c);if(y){f=this.I.cloneNode(!0);var v;(v=this.J)&&(v=v.create)&&v(f)}d&&(f._k=e,this.g[e]=f);return f};
k.apply=function(a,b,c,d){this.I||(this.I=a=U(this,Q[this.l]));if(!this.F){b||(b=this.store?this.store[d]:a._m);c&&this.observe&&(this.store.view=c);this.G(a._p||Ea(this,a),!1,b,d,c);var e;(e=this.J)&&(e=e.change)&&a!==this.I&&e(a);return this}};
...
k.replace=function(a,b,c,d){"undefined"===typeof d&&("number"===typeof a?(d=a,a=this.b[d]):d=this.index(a));this.add(b,c,d,a);Fa(this,a);var e;(e=this.J)&&(e=e.remove)&&e(a);return this};
