...
this.update(this.b[h],a[h],b,h):this.add(a[h],b,this.root);if(c<this.length){this.store&&this.store.splice(c);h=this.b.splice(c);this.length=c;c=h.length;for(var n=0;n<c;n++)this.root.removeChild(h[n])}}return this};g.add=function(a,b,d){var c=this.length;b=this.create(a,b,c);this.store?this.store[c]=a:this.l&&(b._m=a);b._i=c;(d||this.root).appendChild(b);this.b[c]=b;this.length++;return this};
