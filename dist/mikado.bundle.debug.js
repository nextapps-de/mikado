...
function ca(a, b) {
  n[a] || (G(1, a, F, b), n[a] = 1, w[a] = b || null);
  return this;
}
let H, I, da;
if (B || C) {
    ...
    if (d < h) {
      ...
      for (r = d + 1; r < l; r++) {
        if (!y && r < k && e[r]._mkk === u && (y = r + 1), !x && r < h && b[r][f] === D && (x = r + 1), y && x) {
          y >= x ? (p = e[y - 1], a.root.insertBefore(p, v), a.update(p, t, c, d, 1), y === x ? (1 < r - d && a.root.insertBefore(v, e[y]), e[d] = e[r], (e[r] = v) || console.error("Error")) : (la(e, y - 1, d), q++)) : (t = x - 1 + q, a.root.insertBefore(v, e[t] || null), la(e, d, (t > k ? k : t) - 1), q--, d--);
          p = 1;
          break;
        }
      }
...
function ta(a, b, c, d, e, g) {
  ...
  if (!k || "SCRIPT" === k) {
    ...
    if ((l = (k ? a.firstChild : a).nodeValue) && l && l.trim()) {
      ...
      l && l.trim() && (/{{[!?]?#/.test(l) ? ua(h, "html", l, !1, null, e, d) : (e.count++, ua(h, "text", l, !1, null, e, d)));
    }
    if (!k) {
    ...
    for (var p in l) {
      ...
      switch(p) {
        ...
        case "cache":
          break;
        default:
          qa[p] ? r = h.event || (h.event = {}) : (g || "id" !== p && "name" !== p || f.name || /{{[\s\S]+}}/.test(k) || (f.name = k), r = h.attr || (h.attr = {})), t = p;
      }
      t && ua(r || h, t, k, !!r, l, e, d);
    }
  }
  ...
  if (t) {
    for (let v = 0, u; v < t; v++) {
      if (u = p[v], 8 !== u.nodeType && (e.count++, r = ta(u, null, c, d, e, 1))) {
...
function Y(a) {
  ...
  if ("string" === typeof c) {
    for (a = c.split(wa), b._c = c = {}, b = 0; b < a.length; b++) {
      c[a[b]] = 1;
    }
  }
  return c;
...
E.escape = function(a) {
  W.i !== a && (pa.nodeValue = a, W.h = W.innerHTML, W.i = a);
  return W.h;
};
...
E.prototype.unlisten = E.unlisten = function(a) {
  n[a] && (G(0, a, F, w[a]), n[a] = 0, w[a] = null);
  return this;
};
E.Array = O;
const Z = window;
